...
clase de abstraccion construida sobre la api de here los metodos que deberian usarse desde afuera son :
    ...
    inicializador:
    mapa.initialize() <= inicializa el objeto y lo enlaza al elemento que se le paso al constructor 
    ...
    Dependencias: para que esto funcione el html debe incluir los siguientes scripts, mapevents y ui son opcionales 
...
class Mapa{
    ...
    async getCoordinate(dir) {
        ...
        //query = 'Córdoba+Argentina+'+query
        let url = `./geocode?q=${query}`
    ...
    drawRoute(route) {
        try {
            ...
            console.error('las polilineas se niegan a irse')
        }
